...
```{r figdesignmatrix,  out.width="80%", fig.align = 'center', fig.cap="Possible design matrices of group-time model.", echo=FALSE}
...
plotA <- ggplot(input_dmf, aes(x = regressor, y = measurement, fill = value)) +
  ...
  labs(x="regressors", y="scans", title="(A)") +
  # design
...
plotB <- ggplot(input_dmc, aes(x = regressor, y = measurement, fill = value)) +
  geom_tile() +
  scale_fill_gradient(low="black", high="white") +
  labs(x="regressors", y="scans", title="(B)") +
  # design
