...
# do not evaluate if saved already
...
p<-ggplot(aes(as.factor(roi), mean),data=final_tsnr) +
  ...
  legend.position="")
ggsave("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/tsnr.jpeg", height = 6.604, units="cm", p)
```
...
networks=c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/DMN_thresholded_for_clusterFWE005.png", "/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/Rew_thresholded_for_clusterFWE005.png")
tsnr=c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/tsnr.jpeg")
...
knitr::include_graphics(c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIagesex_PCCcc_avgBMI_deact.pdf", "/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIagesexfd_PCCcc_avgBMI_deact.pdf"))
```
...
```{r "BMIFDagesexPCCccavgBMIdeact", fig.cap="Negative association of average BMI and FC with PCC/precuneus in AROMA+CC preprocessed data, adjusted for BMI change, average mFD and change in mFD", fig.hold=TRUE, out.width = "100%"}
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_PCCcc_avgBMI_deact.pdf")
```
...
```{r "BMIFDagesexNACCcccgnBMIdeact", fig.cap="Significant cluster with a negative Effect of change BMI on NAcc to posterior-medial frontal region, adjusted for age, sex, mean BMI, average mFD and change in mFD", fig.subcap=c("in AROMA+CC", "in AROMA+CC+GSR data"), out.width = "50%", fig.hold=TRUE, eval=TRUE}
knitr::include_graphics(c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCcc_cngBMI_deact.pdf","/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCgsr_cngBMI_deact.pdf"))
```
...
```{r "BMIFDagesexNACCccavgFDact", fig.cap="Significant cluster with a positive Effect of average mFD on connectivity between NAcc and motor cortex, adjusted for age, sex, mean BMI, change in BMI and change in mFD", fig.subcap=c("in AROMA+CC", "in AROMA+CC+GSR data"), out.width = "50%", eval=TRUE}
knitr::include_graphics(c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCcc_avgFD_act.pdf","/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCgsr_avgFD_act.pdf"))
```
...
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/FDagesex_NACCcc_avgFD_act.pdf")
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/FDagesex_NACCgsr_avgFD_act.pdf")
```




```{r tableBMImodel, echo=FALSE}
...
```{r tableBMIFDmodel, echo=FALSE}
tab_BMIFDmodel <- mk_FCTables()[[3]]
tab_BMIFDmodel
```

```{r tableFDmodel, echo=FALSE}
