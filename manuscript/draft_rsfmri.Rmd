...
final <- readRDS(file = "./report/tab/final.rds")
...
dfBL <- readRDS(file = "./report/tab/dfBL.rds")
...
fig_BMIdescr <- readRDS(file = "./report/fig/fig_BMIdescr.rds")
fig_BMIdescr
```
...
tab <- readRDS(file = "./report/fig/tableQcfc.rds")
tab
```
...
#setwd(knitr::opts_knit$get("root.dir"))
networks = c("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/DMN_thresholded_for_clusterFWE005.pdf",
             "/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/Rew_thresholded_for_clusterFWE005.pdf")
...
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIagesexfd_PCCcc_avgBMI_deact.pdf")
```

```{r "BMIagesex_PCCcc_avgBMI_deact", out.width = "85%"}
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIagesex_PCCcc_avgBMI_deact.pdf")
```
...
<!-- ### DMN -->
<!-- cc -->The effect of average BMI on connectivity between the PCC and other regions reported previously is confirmed. There is a significant association between average BMI and the connecitivity between PCC and three other clusters. Results are detailed in Table \@ref(tab:tableBMIFDmodel).
...
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCcc_avgFD_act.pdf")
```

```{r "BMIFDagesex_NACCcc_cgnBMI_deact", out.width = "75%"}
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCcc_cngBMI_deact.pdf")
```

```{r "BMIFDagesex_NACCgsr_avgFD_act", out.width = "75%"}
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCgsr_avgFD_act.pdf")
```

```{r "BMIFDagesex_NACCgsr_cgnBMI_deact", out.width = "75%"}
knitr::include_graphics("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/report/BMIFDagesex_NACCgsr_cngBMI_deact.pdf")
```
