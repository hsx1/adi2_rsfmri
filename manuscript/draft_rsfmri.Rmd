...
```{r figtSNR,fig.cap="Lower tSNR in the region of interest NAcc versus precuneus used for seed-based connectivity (shown are all 101 timepoints)", out.width="60%",  echo=FALSE}
p
```
...
Similarly, there were no significant clusters when leaving out mean FD. Results did not differ between AROMA+CC and AROMA+CC+GSR preprocessing pipelines.
