...
knitr::include_graphics(c("../report/BMIagesex_PCCcc_avgBMI_deact.pdf", "../report/BMIagesexfd_PCCcc_avgBMI_deact.pdf"))
```
...
```{r "BMIagesexfd_PCCcc_avgBMI_deact", fig.cap="Negative association of average BMI and FC with PCC/precuneus in AROMA+CC preprocessed data, adjusted for BMI change, average mFD and change in mFD", fig.hold=TRUE, out.width = "85%"}
knitr::include_graphics("../report/fig/BMIagesexfd_PCCcc_avgBMI_deact.pdf")
```

```{r "BMIagesex_PCCcc_avgBMI_deact", fig.cap="Negative association of average BMI and FC with PCC/precuneus in AROMA+CC preprocessed data, adjusted for BMI change, average mFD and change in mFD", fig.hold=TRUE, out.width = "85%"}
...
knitr::include_graphics("../report/FDagesex_NACCcc_avgFD_act.pdf")
knitr::include_graphics("../report/FDagesex_NACCgsr_avgFD_act.pdf")
```
