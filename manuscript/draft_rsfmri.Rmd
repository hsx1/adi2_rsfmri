...
<!-- Regions of interest (definition and transformation into freesurfer long space) --> Seed regions were ... mm spheres in the precuneus ((MNI)X,Y,Z = x,x,x) associated with the default mode network, and the Nucleus Accumbens (x,x,x) by averaging the time series across voxels.
