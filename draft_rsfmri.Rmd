...
#set wd (change depending on user)
setwd("/data/pt_02161/Analysis/Project2_resting_state/seed-based/Second_level /code_and_manuscript/")
...
p <- ggplot(data=dfBL, aes(group = condition, x=Age_BL, fill=condition)) +
  ...
  scale_fill_manual(
    ...
    labels = c("intervention", "control")) +
  theme_bw()
tab_age <- describeBy(x=dfBL$Age_BL, group=dfBL$condition, mat=T)
# Sex
